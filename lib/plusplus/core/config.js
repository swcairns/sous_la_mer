ig.module(
    ...
    .defines(function () {
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.CHARACTER.MAX_VEL_UNGROUNDED_Y = 100;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.CHARACTER.FRICTION_UNGROUNDED_X = 1600;
         ...
         * @memberof ig.CONFIG.ENTITY
         */
        ig.CONFIG.CHARACTER.FRICTION_UNGROUNDED_Y = 1600;
